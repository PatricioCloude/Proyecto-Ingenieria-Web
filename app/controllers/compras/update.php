<?php
    ...
    $sentencia = $pdo->prepare("CALL update_compras(:id_compra, :id_producto, :nro_compra, :fecha_compra, :id_proveedor, :comprobante, :id_usuario, :precio_compra, :cantidad, :fyh_actualizacion)");
    ...
    if($sentencia->execute()){
        ...
        $sentencia = $pdo->prepare("CALL update_stock_compras(:id_producto, :stock)");
