...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0" style=" font-weight: bold">Listado de Productos</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($productos_datos as $productos_dato) {
                                            ...
                                            <tr>
                                                <td>
                                                    <center><?php echo $contador = $contador + 1; ?>
                                                </td>
                                                <td>
                                                    <center><?php echo $productos_dato['codigo']; ?>
                                                </td>
                                                <td>
                                                    <center><?php echo $productos_dato['categoria']; ?>
                                                </td>
                                                <td>
                                                    <center>
                                                ...
                                                <td>
                                                    <center><?php echo $productos_dato['nombre']; ?>
                                                </td>
                                                ...
                                                <td>
                                                    <center><?php echo $productos_dato['precio_compra']; ?>
                                                </td>
                                                <td>
                                                    <center><?php echo $productos_dato['precio_venta']; ?>
                                                </td>
                                                <td>
                                                    <center><?php echo $productos_dato['fecha_ingreso']; ?>
                                                </td>
