...
<body style="background: #00d2ff; /* fallback for old browsers */
  background: -webkit-linear-gradient(to right, #00d2ff, #3a7bd5); /* Chrome 10-25, Safari 5.1-6 */
  background: linear-gradient(to right, #00d2ff, #3a7bd5);" class="hold-transition login-page">
    <div class="login-box">
        <!-- /.login-logo -->
        ...
        <center>
            <img src="https://img.freepik.com/vector-gratis/gerentes-startups-que-presentan-analizan-tabla-crecimiento-ventas-grupo-trabajadores-monton-dinero-efectivo-cohetes-diagramas-barras-flecha-monton-dinero_74855-14166.jpg?w=996&t=st=1673983349~exp=1673983949~hmac=b50c9a1d93c8d39cec56f10df254278c5ab4acba8fb0c9a52e31eede2ebf03bc" alt="" width="300px">
        </center>
        <br>
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="#" class="h1" style="color:dodgerblue  "><b>Sistema de ALMACÉN</b> OVALTECH E.I.R.L.</a>
            </div>
            <div class="card-body">
                ...
                <form action="../app/controllers/login/ingreso.php" method="post">
                    ...
                    <div class="row">
                        <!-- /.col -->
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary btn-block" style="background: #00d2ff; /* fallback for old browsers */
                            background: -webkit-linear-gradient(to right, #00d2ff, #3a7bd5); /* Chrome 10-25, Safari 5.1-6 */
                            background: linear-gradient(to right, #00d2ff, #3a7bd5);">Ingresar</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
